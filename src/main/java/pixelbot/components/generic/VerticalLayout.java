...
public class VerticalLayout implements LayoutManager {
	...
	private int anchor; // TOP, BOTTOM or CENTER ...where are the components positioned in an
						// overlarge space

	// Constructors
	/**
	 * Constructs an instance of VerticalLayout with a vertical vgap of 5 pixels, horizontal
	 * centering and anchored to the top of the display area.
	 */
	...
	/**
	 * Constructs a VerticalLayout instance anchored to the top with the specified vgap and
	...
	public String toString() {
		return getClass().getName() + "[vgap=" + this.vgap + " align=" + this.alignment
				+ " anchor=" + this.anchor + "]";
	}
}
